                    ...
                    <form class="form-horizontal" action="{{ route('admin.jabatan.edit') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label class="col-sm-12">Jabatan</label>
                                <div class="col-sm-12">
                                    <input type="text" name="jabatan" value="{{ $j->jabatan }}" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-12">Gaji/hari</label>
                                <div class="col-sm-12">
                                    <input type="text" name="salary" value="{{ $j->salary }}" class="form-control" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-12">Lembur/Jam</label>
                                <div class="col-sm-12">
                                    <input type="text" name="overtime" value="{{ $j->overtime }}" class="form-control" required>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
