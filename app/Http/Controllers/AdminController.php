...
class AdminController extends Controller
{
    ...
    public function pegawai()
    {
        ...
        $data = [
            'title'         => 'Data Pegawai',
            'user'          => Auth::user(),
            'pegawai'       => Pegawai::with('relasiJabatan')->get(),
            'jabatan'       => Jabatan::all(),
            'jekel'         => ['L', 'P'],
            'stapeg'        => [1, 0],
    ...
    {
        $akun = User::with('pegawai')->where('role_id', 2)->get();
    ...
    public function simpan_lembur_pegawai(Request $request)
    {
        ...
        $pakaiBatasJamLembur = true; // ubah ke true jika ingin aktifkan aturan jam 16.00
    ...
    public function edit_lembur_pegawai(Request $request)
    {
        ...
        $pakaiBatasJamLembur = true; // ubah true jika dibutuhkan
